...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        String[] redmeat =
               {"1、準備1根胡蘿蔔，2根芹菜，半個洋蔥，把它們洗淨後都切成小塊，取烤盤，先在烤盤上刷一層油，再平鋪上三種蔬菜，烤箱預熱到225度，放入烤盤烘烤約20分鐘，然後取出，取來湯鍋，注入 1.5 升的清水，放入烤過的蔬菜，打火煮開，煮開後放入一小片香葉，再撒少許白胡椒粉，攪勻後轉小火，煮約1個小時，就先叫它蔬菜高湯吧。",
                "2、一個小時後關火，取濾網，過濾出無雜質的蔬菜高湯，過濾的時候可以一手拿濾網，一手拿小湯匙，邊過濾邊用湯匙按壓蔬菜，以過濾出更多的湯汁。",
                "3.牛肉洗淨，切成大塊，然後用廚房用紙吸去表面的水分，取平底鍋，倒入一大湯匙橄欖油，依次放入牛肉塊，中小火煎至金黃色，煎好後放入湯鍋中。",
                "4.把盛有牛肉的小鍋放到火上，倒入80C.C.紅酒，中火加熱，直至煮乾，中間別忘了時常拌炒一下。",
                "5.這時倒入之前做好的蔬菜高湯，加入兩大匙罐裝番茄醬，攪勻。",
                "6.還需要加一點培根，最好不省略培根，把培根放入小鍋內煎香，再放到牛肉鍋裡一起煮，在放番茄醬的時候一起加入就可以了，除此之外別忘了再加一片香葉，大火煮開後轉小火，蓋上鍋蓋煮上 2.5 - 3 個小時。還需要準備一些蔬菜，有胡蘿蔔、馬鈴薯、洋蔥、蘑菇，把它們洗淨後都切成大塊，蔬菜在最後 30-40 分鐘時放入。",
        ...
        String[] potato =
                {"1、準備材料，洋蔥切碎，魚肉洗淨控乾表面水份。",
                        ...
                        "6.做白葡萄酒酥油汁：平底鍋中加入白葡萄酒加入洋蔥碎，小火煮開慢慢少量多次的加入酥油，用攪拌器朝一個方向攪拌，直至酥油全部吸收湯汁變稠即可澆在烤好的鱈魚上一起吃。"};
        ...
        String[] soup =
                {"1.先來煮牛肉吧，把買來的牛肉洗淨，切成小塊，放到湯鍋裡，注入適量的清水，放到火上大火煮滾，撇去浮沫，改小火燜至牛肉軟爛，看看時間，兩個小時以後就可以了~ 燉牛肉的時候我只點了幾滴料酒，臨關火前加了點鹽調味，其他什麼調料都沒放~ 如果家裡有紅茶包的話，可以丟一個下去，可以讓牛肉更容易酥爛。",
                        "2.將青菜、馬鈴薯、胡蘿蔔洗淨去皮切小塊，洋蔥、捲心菜、紅腸切片，番茄去皮切小塊，芹菜洗淨切小塊，切的時候大小最好一致，如果你是剛剛才燉的牛肉，那青菜要等到牛肉燉好後再切。",
                        "3.取來另一個鍋，放入奶油，溶化後放入馬鈴薯塊，隨後放入紅腸，待香味都出來了，放入其他蔬菜，再放入番茄醬，加入少許的鹽調一下味，翻炒均勻後趁熱全部倒入剛剛燉好的牛肉湯鍋中，用小火繼續煮燉~",
                        "4.在快燉好的時候還要炒一下麵粉，將麵粉倒入乾淨的炒鍋中，用小火將麵粉炒至微黃，其間要不停的攪拌，然後趁熱加到正在煮燉的紅菜湯裡，用湯勺攪拌均勻，加入的多少看你自己的喜好，希望濃稠些可以多放一點，不放也可以",
                        "5.最後再煮上一會，待裡面的蔬菜都軟爛了就可以了，關火前加入鹽，糖，胡椒粉攪勻就可以吃了。"};
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        String[] re_meat =
                       {"1.把雞胸肉平鋪在保鮮膜上，並將雞胸肉拍扁。",
                        "2.灑上少許的黑胡椒、鹽巴，並放上一匙的大蒜醬。",
                        "3.將雞肉從各個方向往中間包，並利用保鮮膜將雞肉捲起來成一個球狀後，丟進冷凍庫，冰30分鐘。(冰的動作是要讓雞肉定型，如果省略內餡的奶油很可能會流出來，所以冰的動作非常重要。)",
                        "4.30分鐘後從冰箱取出雞胸肉，然後依需沾裹(1)麵粉、(2)蛋液、(3)麵包粉。",
                        "5.沾裹後的雞肉再一次放進冷凍庫，冰15分鐘。",
                        "6.起油鍋，加熱至約180度後下鍋油炸60秒，60秒後翻面，再炸60秒，起鍋後直接放入烤箱，用攝氏180度，烤12分鐘。(1.如果是使用小烤箱一定要覆蓋鋁箔紙，以免雞胸肉烤焦；2.烘烤的時間會依照雞胸的厚度、大小的不同而有所增減。)",
